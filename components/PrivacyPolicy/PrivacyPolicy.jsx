...
const PrivacyPolicy = () => {
  return (
    <div className="min-h-screen bg-[#0a0a12] text-[#e0e0ff] pt-24 pb-16 px-6 md:px-16 relative overflow-hidden">
      {/* Glowing orb effects - matching your footer */}
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <section className="mb-12">
          <p className="text-lg text-[#b0b0ff] leading-relaxed mb-6">
        ...
        <div className="grid gap-8">
          ...
          <section className="bg-[#0f0f1a] rounded-xl p-6 border border-[#00f0ff]/20">
            <div className="flex items-center gap-3 mb-4">
              <FaDatabase className="text-2xl text-[#00f0ff]" />
              <h2 className="text-2xl font-semibold text-[#00f0ff]">Information We Collect</h2>
            </div>
            <div className="text-[#b0b0ff] space-y-4">
          ...
          <section className="bg-[#0f0f1a] rounded-xl p-6 border border-[#00f0ff]/20">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-semibold text-[#00f0ff]">How We Use Your Information</h2>
            </div>
            <div className="text-[#b0b0ff] space-y-4">
          ...
          <section className="bg-[#0f0f1a] rounded-xl p-6 border border-[#00f0ff]/20">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-semibold text-[#00f0ff]">Cookies and Tracking</h2>
            </div>
            <div className="text-[#b0b0ff] space-y-4">
              <p>
          ...
          {/* Data Sharing */}
          <section className="bg-[#0f0f1a] rounded-xl p-6 border border-[#00f0ff]/20">
            <h2 className="text-2xl font-semibold text-[#00f0ff] mb-4">Data Sharing and Disclosure</h2>
            <div className="text-[#b0b0ff] space-y-4">
              <p>
          ...
          {/* Your Rights */}
          <section className="bg-[#0f0f1a] rounded-xl p-6 border border-[#00f0ff]/20">
            <h2 className="text-2xl font-semibold text-[#00f0ff] mb-4">Your Data Protection Rights</h2>
            <div className="text-[#b0b0ff] space-y-4">
          ...
          {/* Changes to Policy */}
          <section className="bg-[#0f0f1a] rounded-xl p-6 border border-[#00f0ff]/20">
            <h2 className="text-2xl font-semibold text-[#00f0ff] mb-4">Changes to This Privacy Policy</h2>
            <div className="text-[#b0b0ff]">
              <p>
          ...
          <section className="bg-[#0f0f1a] rounded-xl p-6 border border-[#00f0ff]/20">
            ...
            <div className="text-[#b0b0ff] space-y-4">
              ...
              <ul className="space-y-2">
                ...
                <li>By visiting this page on our website: <Link href="/contact" className="text-[#00f0ff] hover:underline">Contact Us</Link></li>
