...
const TermsOfService = () => {
  return (
    <div className="min-h-screen bg-[#0a0a12] text-[#e0e0ff] pt-24 pb-16 px-6 md:px-16 relative overflow-hidden">
      {/* Enhanced glowing orb effects */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute rounded-full bg-[#00f0ff] blur-3xl opacity-15 w-80 h-80 -left-40 -bottom-40 animate-pulse"></div>
        <div className="absolute rounded-full bg-[#0066ff] blur-3xl opacity-15 w-96 h-96 -right-40 -top-40 animate-pulse"></div>
        <div className="absolute rounded-full bg-[#7e22ce] blur-3xl opacity-10 w-72 h-72 left-1/4 top-1/3 animate-pulse delay-1000"></div>
      </div>
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-4 mb-6">
            <div className="relative">
              <div className="absolute inset-0 bg-[#00f0ff] rounded-full opacity-20 animate-ping"></div>
          ...
          <p className="text-xl text-[#b0b0ff] max-w-2xl mx-auto mb-6">
        ...
        <section className="mb-16 text-center">
          <div className="bg-gradient-to-br from-[#0f0f1a] to-[#1a1a2a] rounded-2xl p-8 border border-[#00f0ff]/30 shadow-lg shadow-[#00f0ff]/10">
            <p className="text-xl md:text-2xl text-[#e0e0ff] leading-relaxed font-light italic">
        ...
        <div className="grid gap-10">
          {/* Agreement to Terms */}
          <section className="bg-gradient-to-br from-[#0f0f1a] to-[#1a1a2a] rounded-2xl p-8 border border-[#00f0ff]/20 shadow-lg hover:shadow-[#00f0ff]/15 transition-all duration-300 hover:-translate-y-1">
            ...
            <div className="text-[#b0b0ff] space-y-4 pl-4 border-l-2 border-[#00f0ff]/30">
          ...
          <section className="bg-gradient-to-br from-[#0f0f1a] to-[#1a1a2a] rounded-2xl p-8 border border-[#0066ff]/20 shadow-lg hover:shadow-[#0066ff]/15 transition-all duration-300 hover:-translate-y-1">
            <div className="flex items-center gap-4 mb-6">
            ...
            <div className="text-[#b0b0ff] space-y-4 pl-4 border-l-2 border-[#0066ff]/30">
          ...
          <section className="bg-gradient-to-br from-[#0f0f1a] to-[#1a1a2a] rounded-2xl p-8 border border-[#7e22ce]/20 shadow-lg hover:shadow-[#7e22ce]/15 transition-all duration-300 hover:-translate-y-1">
            <div className="flex items-center gap-4 mb-6">
            ...
            <div className="text-[#b0b0ff] space-y-4 pl-4 border-l-2 border-[#7e22ce]/30">
          ...
          <section className="bg-gradient-to-br from-[#0f0f1a] to-[#1a1a2a] rounded-2xl p-8 border border-[#ff3366]/20 shadow-lg hover:shadow-[#ff3366]/15 transition-all duration-300 hover:-translate-y-1">
            <div className="flex items-center gap-4 mb-6">
            ...
            <div className="text-[#b0b0ff] space-y-4 pl-4 border-l-2 border-[#ff3366]/30">
          ...
          {/* Termination */}
          <section className="bg-gradient-to-br from-[#0f0f1a] to-[#1a1a2a] rounded-2xl p-8 border border-[#ff8c00]/20 shadow-lg hover:shadow-[#ff8c00]/15 transition-all duration-300 hover:-translate-y-1">
            <div className="flex items-center gap-4 mb-6">
            ...
            <div className="text-[#b0b0ff] space-y-4 pl-4 border-l-2 border-[#ff8c00]/30">
          ...
          {/* Contact Information */}
          <section className="bg-gradient-to-br from-[#0f0f1a] to-[#1a1a2a] rounded-2xl p-8 border border-[#00f0ff]/30 shadow-lg text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-[#00f0ff] mb-6">Have Questions?</h2>
            <p className="text-[#b0b0ff] mb-6">If you have any questions about these Terms, please contact us:</p>
            <div className="flex flex-col md:flex-row justify-center items-center gap-6">
              <Link 
                href="/contact" 
                className="px-6 py-3 bg-gradient-to-r from-[#00f0ff] to-[#0066ff] text-[#0a0a12] font-semibold rounded-lg hover:shadow-lg hover:shadow-[#00f0ff]/30 transition-all duration-300"
              >
                Contact Us
              </Link>
              <a 
                href="mailto:info@a2it.com" 
                className="px-6 py-3 border border-[#00f0ff] text-[#00f0ff] font-semibold rounded-lg hover:bg-[#00f0ff] hover:text-[#0a0a12] transition-all duration-300"
              >
                Email Us
              </a>
            </div>
