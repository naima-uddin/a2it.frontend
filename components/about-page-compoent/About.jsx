  ...
  return (
    <div className="bg-[#0a0a12] text-[#e0e0ff]">
      ...
      <section className="relative overflow-hidden">
        <div className="container mx-auto px-6 py-10 md:py-28 text-center relative z-10">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
            About <span className="text-[#00f0ff]">A2IT </span>
          </h1>
          <div className="max-w-3xl mx-auto">
            <p className="text-xl md:text-2xl text-[#b0b0ff] mb-8 leading-relaxed">
