  ...
  return (
    <div className="bg-[#0a0a12] text-[#e0e0ff] overflow-hidden">
      ...
      <section className="relative h-[60vh] sm:h-[70vh] md:h-[70vh] lg:h-[75vh] xl:[80vh] flex items-center justify-center overflow-hidden">
        <div
          className="absolute inset-0 bg-[url('/assets/eCommerce/5.avif')] bg-cover bg-center opacity-60"
          style={{ backgroundPosition: "center 30%", transform: "scale(1.1)" }}
        ></div>

        {/* Gradient overlay */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#0a0a12] via-[#0a0a12]/90 to-[#0a0a12]"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-12 relative z-10 text-center">
          <motion.div
            ...
            className="mb-8"
          >
            <div className="inline-flex items-center bg-[#12121a] rounded-full px-6 py-3 border border-[#00f0ff]/30 mb-8">
              <FiPackage className="text-[#00f0ff] mr-2" />
              <span className="text-sm text-[#b0b0ff]">
                Amazon FBA Services
              </span>
            </div>
            ...
            <motion.p
              ...
              className="text-xl text-[#b0b0ff] max-w-3xl mx-auto mb-12"
            >
            ...
            >
              ...
              <button
                ...
                className="flex items-center text-[#b0b0ff] hover:text-[#00f0ff] transition-colors duration-300"
              >
      ...
      <motion.section
        style={{ opacity, scale }}
        ref={sectionRef}
        className="py-20 px-6 sm:px-12 bg-gradient-to-b from-[#12121a] to-[#0a0a12]"
      >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <motion.div
                ...
                className="text-center p-6 bg-[#0a0a12] rounded-2xl border border-[#00f0ff]/20 hover:border-[#00f0ff] transition-colors duration-300 group"
              >
                ...
                <motion.div
                  ...
                  className="text-3xl md:text-4xl font-bold text-[#00f0ff] mb-2"
                >
                  {stat.value}
                </motion.div>
                <div className="text-[#b0b0ff] text-sm">{stat.label}</div>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section
        id="features"
        ref={featuresRef}
        className="py-10 px-6 sm:px-12 bg-[#0a0a12]"
      >
        <div className="max-w-7xl mx-auto">
          <motion.div
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-stretch">
              ...
              <div className="sticky top-24 space-y-4">
                {features.map((feature, index) => (
                  <motion.button
                    ...
                    className={`w-full text-left p-6 rounded-2xl transition-all duration-300 ${
                      activeFeature === index
                        ? "bg-gradient-to-r from-[#00f0ff] to-[#0066ff] text-[#0a0a12] shadow-xl"
                        : "bg-[#12121a] text-[#b0b0ff] hover:bg-[#1a1a2e]"
                    }`}
                  >
                ...
                <div className="flex justify-center mt-6">
                  <button
                    ...
                    className="w-12 h-12 flex items-center justify-center bg-[#12121a] text-[#00f0ff] rounded-full hover:bg-[#1a1a2e] transition-colors duration-300"
                    aria-label={
            ...
            <div className="lg:w-3/5">
              <div className="relative h-96 lg:h-[500px] bg-[#12121a] rounded-2xl overflow-hidden border border-[#00f0ff]/20">
                {features.map((feature, index) => (
                  <motion.div
                    key={index}
                    initial={false}
                  ...
                  >
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-[#b0b0ff]">{feature.description}</p>
                    </div>
            ...
            {[
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-[#b0b0ff]">{benefit.description}</p>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={index} className="flex items-center">
                    ...
                    <div className="text-[#b0b0ff]">{stat.label}</div>
                  </div>
                ))}
              </div>

              <p className="text-[#b0b0ff] mt-6">
            ...
            >
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.8, delay: 0.5 }}
                className="absolute -bottom-6 -right-6 bg-[#12121a] p-6 rounded-2xl border border-[#00f0ff]/20 shadow-xl"
              >
                ...
                <div className="text-center mt-4 text-sm text-[#00f0ff]">
                  Sales Growth
                </div>
              </motion.div>
            </motion.div>
      ...
      <section className="py-32 px-6 sm:px-12 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            Ready to <span className="text-[#00f0ff]">Streamline</span> Your FBA
            Operations?
          </motion.h2>
