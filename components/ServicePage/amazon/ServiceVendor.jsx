  ...
  return (
    <div className="bg-[#0a0a12] text-[#e0e0ff] overflow-hidden">
      ...
      <section className="relative flex items-center justify-center h-[40vh] sm:h-[50vh] md:h-[60vh] lg:h-[65vh] xl:[80vh] overflow-hidden">
        <div className="absolute inset-0 bg-[url('/assets/vendor/hero.avif')] bg-cover bg-center opacity-50"></div>
        ...
        >
          <div className="inline-block mb-6">
            <div className="flex items-center justify-center bg-[#12121a] rounded-full px-6 py-2 border border-[#00f0ff]/30">
      ...
      {/* Key Features */}
      <section className="py-20 px-6 sm:px-12 bg-gradient-to-r from-[#12121a] to-[#0a0a12]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className="p-6 bg-[#0a0a12] rounded-xl border border-[#00f0ff]/20 hover:border-[#00f0ff] transition-all duration-300"
              >
      ...
      {/* Process Section */}
      <section className="py-20 px-6 sm:px-12 bg-gradient-to-r from-[#0a0a12] to-[#12121a]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-6xl mx-auto">
          {[
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.5, delay: i * 0.1 }}
              className="p-6 text-left bg-[#12121a] rounded-xl border border-[#00f0ff]/20 hover:border-[#00f0ff] transition-all duration-300"
            >
              <div className="text-2xl font-bold text-[#00f0ff] mb-2">
                {item.step}
              </div>
              <h3 className="text-lg font-semibold mb-2">{item.title}</h3>
              <p className="text-[#b0b0ff] text-sm">{item.desc}</p>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      <section className="py-28 px-6 sm:px-12 relative">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          >
            Ready to Scale with{" "}
            <span className="text-[#00f0ff]">Vendor Central?</span>
          </motion.h2>
          <p className="text-[#b0b0ff] mb-8">
