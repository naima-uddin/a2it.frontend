        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-12 relative z-10 text-center">
          ...
          >
            ...
            >
              ...
              <span className="text-sm text-[#b0b0ff]">Amazon DSP Services</span>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-[#0a0a12] rounded-2xl border border-[#00f0ff]/20 p-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-6 mb-8">
              {[
                ...
                >
                  ...
                  <div className="text-[#b0b0ff] text-sm">{metric.label}</div>
                </motion.div>
              ))}
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="flex justify-between text-xs text-[#b0b0ff] mt-2">
                {advertisingChannels.map((channel, index) => (
            ...
            <div className="bg-[#12121a] rounded-xl p-4">
              ...
              <div className="h-40 relative">
                ...
                <div className="absolute bottom-0 left-0 text-xs text-[#b0b0ff]">Impressions</div>
                <div className="absolute top-0 right-0 text-xs text-[#b0b0ff]">Conversions</div>
              </div>
            </div>
          </div>
        </div>
            ...
            {[
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-[#b0b0ff] mb-4">{channel.description}</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="bg-[#12121a] p-6 rounded-2xl border border-[#00f0ff]/20">
                ...
                <div className="flex justify-between mt-4 text-sm text-[#b0b0ff]">
                  <span>Week 1</span>
                  <span>Week 2</span>
                  <span>Week 3</span>
                  <span>Week 4</span>
