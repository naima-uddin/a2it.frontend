  ...
  return (
    <div className="bg-[#0a0a12] text-[#e0e0ff] overflow-hidden">
      ...
      <section className="relative flex flex-col items-center justify-center h-[40vh] sm:h-[50vh] md:h-[60vh] lg:h-[65vh] xl:h-[80vh] overflow-hidden">
        {/* Background Image */}
        <div className="absolute inset-0 bg-[url('/assets/amazon/1.avif')] bg-cover bg-center opacity-60"></div>
        <div className="absolute inset-0 bg-gradient-to-b from-[#121214] via-[#0a0a12]/80 to-[#0a0a12]"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-12 relative z-10 text-center">
          ...
          >
            ...
            >
              <div className="flex items-center justify-center bg-[#12121a] rounded-full px-4 sm:px-6 py-2 border border-[#00f0ff]/30">
                <FiDollarSign className="text-[#00f0ff] mr-2" />
                <span className="text-xs sm:text-sm text-[#b0b0ff]">
            ...
            <p className="text-lg sm:text-xl text-[#b0b0ff] max-w-3xl mx-auto mb-6">
            ...
            >
              ...
              <button
                ...
                className="flex items-center text-sm sm:text-base text-[#b0b0ff] hover:text-[#00f0ff] transition-colors duration-300"
              >
      ...
      <section className="py-16 px-6 sm:px-12 bg-gradient-to-r from-[#12121a] to-[#0a0a12]">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <motion.div
                ...
                className="text-center p-6 bg-[#0a0a12] rounded-xl border border-[#00f0ff]/20 hover:border-[#00f0ff] transition-colors duration-300"
              >
                <motion.div
                  initial={{ scale: 0.5 }}
                  whileInView={{ scale: 1 }}
      ...
      <section id="how-it-works" className="py-10 px-6 sm:px-12 bg-[#12121a]">
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
                ...
                <button
                  ...
                  className={`px-6 py-3 mx-2 rounded-full transition-all duration-300 ${
                    activeStep === index
                      ...
                      : "bg-[#0a0a12] text-[#b0b0ff] hover:bg-[#12121a]"
                  }`}
                >
                  {step}
                </button>
              ...
              {[
                ...
                >
                  <div className="md:w-1/2 p-6">
                    ...
                    <p className="text-[#b0b0ff] mb-6">{step.description}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className="group relative bg-[#12121a] rounded-xl overflow-hidden border border-[#00f0ff]/20 hover:border-[#00f0ff] transition-all duration-300"
              >
                <div
                  className="h-40 bg-cover bg-center opacity-50 group-hover:opacity-70 transition-opacity duration-500"
      ...
      <section className="py-10 px-6 sm:px-12 relative">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            Ready to <span className="text-[#00f0ff]">Unlock</span> Your Amazon
            Affiliate Potential?
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 40 }}
