...
const ServiceMarketing = () => {
  return (
    <div className="max-w-6xl mx-auto px-6 py-12 bg-[#0a0a12] text-[#e0e0ff]">
      {/* Hero Section */}
      <motion.div
      ...
      <section className="mb-16">
        <h2 className="text-2xl font-semibold mb-4 text-[#00f0ff]">
      ...
      {/* Core Components */}
      <section className="mb-16">
        <h2 className="text-2xl font-semibold mb-8 text-[#00f0ff]">
          Core Components of A2IT's Amazon Marketing Services
        </h2>
        <div className="grid md:grid-cols-2 gap-8">
          <div className="p-6 border border-[#00f0ff]/20 rounded-2xl bg-[#12121a] hover:border-[#00f0ff] transition">
          ...
          <div className="p-6 border border-[#00f0ff]/20 rounded-2xl bg-[#12121a] hover:border-[#00f0ff] transition">
            <FiTrendingUp className="text-[#00f0ff] text-3xl mb-4" />
            <h3 className="text-xl font-semibold mb-2">
      ...
      {/* Process */}
      <section className="mb-16">
        <h2 className="text-2xl font-semibold mb-8 text-[#00f0ff]">Our Process</h2>
      ...
      {/* Success Stories */}
      <section className="mb-16">
        <h2 className="text-2xl font-semibold mb-8 text-[#00f0ff]">Success Stories</h2>
        <div className="space-y-8">
          <div className="p-6 border border-[#00f0ff]/20 rounded-2xl bg-[#12121a] hover:border-[#00f0ff] transition">
            ...
            <p className="text-[#b0b0ff]">
              ...
              COGS of <span className="font-semibold text-white">$606,793.22</span> in
          ...
          <div className="p-6 border border-[#00f0ff]/20 rounded-2xl bg-[#12121a] hover:border-[#00f0ff] transition">
            ...
            <p className="text-[#b0b0ff]">
              ...
              <span className="font-semibold text-white">30% sales boost</span>.
            </p>
          </div>
        </div>
      </section>
