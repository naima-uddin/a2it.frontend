  ...
  return (
    <div className="bg-[#0a0a12] text-[#e0e0ff] overflow-hidden">
      ...
      <section className="relative flex flex-col lg:flex-row items-center overflow-hidden py-24">
        ...
        <div className="absolute inset-0 bg-[url('/assets/eCommerce/4.jpg')] bg-cover bg-center opacity-10"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-12 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <span className="inline-block px-4 py-2 bg-[#00f0ff] text-[#0a0a12] font-medium mb-6 rounded-full text-sm sm:text-base">
              ECOMMERCE SOLUTIONS
            </span>
            ...
            <p className="text-lg sm:text-xl text-[#b0b0ff] max-w-2xl mb-12">
          ...
          >
            ...
            <div className="relative bg-[#12121a] p-6 rounded-xl border border-[#00f0ff]/30 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                {/* Sales chart */}
                <div className="h-24 sm:h-28 bg-[#0e0e15] rounded-lg p-3 sm:p-4 mb-6">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <div className="bg-[#0e0e15] p-8 rounded-xl border border-[#0066ff]/20 relative overflow-hidden">
                  ...
                  <ul className="space-y-3">
                    {[
                      ...
                      <li key={i} className="flex items-start">
                        <div className="w-6 h-6 bg-[#0066ff]/10 rounded-full flex items-center justify-center text-[#00f0ff] mr-3 mt-1">
      ...
      {/* **Approach Section** */}
      <section className="py-10 px-6 sm:px-12 bg-[#0a0a12]">
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl font-bold mt-4 mb-6">
              What Sets Our{" "}
              <span className="text-[#00f0ff]">Approach Apart</span>
            </h2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <motion.div
                ...
                className="bg-[#12121a] rounded-xl overflow-hidden border border-[#00f0ff]/10 hover:border-[#0066ff]/50 transition-all duration-300 group"
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-[#b0b0ff]">{item.desc}</p>
                </div>
              </motion.div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className="bg-[#0e0e15] rounded-xl overflow-hidden border border-[#00f0ff]/10 group hover:border-[#0066ff]/50 transition-colors"
              >
                <div className="relative h-40 overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0e0e15] to-transparent"></div>
                </div>
                <div className="p-6">
                  <div className="w-12 h-12 bg-[#0066ff]/10 rounded-full flex items-center justify-center text-[#00f0ff] mb-4 -mt-12 relative z-10">
                    {service.icon}
                  </div>
                  ...
                  <ul className="space-y-2">
                    {service.features.map((feature, i) => (
                      <li key={i} className="flex items-center">
                        ...
                        <span className="text-[#b0b0ff]">{feature}</span>
                      </li>
                    ))}
                  </ul>
                </div>
      ...
      <section className="py-10 px-6 sm:px-12 bg-[#0a0a12]">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl font-bold mt-4 mb-6">
              Why a Strategic{" "}
              <span className="text-[#00f0ff]">eCommerce Site Matters</span>
            </h2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className="bg-[#12121a] rounded-xl overflow-hidden border border-[#00f0ff]/10 group hover:border-[#0066ff]/50 transition-colors"
              >
                ...
                <div className="p-8 text-center">
                  ...
                  <p className="text-[#b0b0ff]">{benefit.desc}</p>
                </div>
              </motion.div>
            ))}
          </div>
            ...
            <div className="space-y-8">
              {[
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.5, delay: index * 0.1 }}
                  className="flex items-start bg-[#0a0a12] p-6 rounded-xl border border-[#00f0ff]/10 hover:border-[#0066ff]/50 transition-colors group overflow-hidden"
                >
      ...
      <section className="py-10 px-6 sm:px-12 bg-[#0a0a12]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className="bg-[#12121a] rounded-xl overflow-hidden border border-[#00f0ff]/10 hover:border-[#0066ff]/50 transition-colors group"
              >
                ...
                <div className="p-6">
                  <p className="text-[#b0b0ff] mb-4">{project.description}</p>
                </div>
              </motion.div>
            ))}
          </div>
          ...
          >
            <Link
              href="/portfolio"
              className="inline-flex items-center border-2 border-[#00f0ff] text-[#00f0ff] hover:bg-[#00f0ff]/10 font-semibold py-4 px-8 rounded-lg transition-colors duration-300"
            >
              View All Projects
            </Link>
          </motion.div>
      ...
      {/* **Final CTA Section** */}
      <section className="py-16 px-6 sm:px-12 bg-gradient-to-b from-[#12121a] to-[#0a0a12] relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8, delay: 0.2 }}
            className="text-xl text-[#b0b0ff] mb-6 max-w-2xl mx-auto"
          >
          ...
          >
            ...
            <Link
              href="/portfolio"
              className="inline-flex items-center border-2 border-[#00f0ff] text-[#00f0ff] hover:bg-[#00f0ff]/10 font-semibold py-4 px-12 rounded-lg transition-colors duration-300"
            >
              View Case Studies
            </Link>
          </motion.div>
