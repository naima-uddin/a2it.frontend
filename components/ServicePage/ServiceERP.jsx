...
const ServiceERP = () => {
  ...
  return (
    <div className="bg-[#0a0a12] text-[#e0e0ff] overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-12 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center py-24">
          ...
          >
            ...
            <motion.div
              ...
              className="relative bg-[#12121a] p-1 rounded-xl border border-[#3d5afe]/30 shadow-2xl shadow-[#3d5afe]/10"
            >
              ...
              <div className="bg-[#0e0e15] p-6 rounded-lg overflow-hidden">
      ...
      <section className="py-20 px-6 sm:px-12 bg-[#12121a] relative overflow-hidden">
        {/* Background elements */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {capabilities.map((item, index) => (
              <motion.div
                ...
                className="bg-[#0e0e15] p-8 rounded-xl border border-[#3d5afe]/10 hover:border-[#00bcd4]/50 transition-all duration-300 hover:shadow-[0_0_30px_-10px_rgba(0,188,212,0.5)] group relative overflow-hidden"
              >
                ...
                <p className="text-[#b0b0ff] relative z-10">
                  {item.description}
                </p>
            ...
            <div className="flex flex-col space-y-4">
              {industries.map((industry, index) => (
                <motion.div
                  ...
                  className={`bg-[#12121a] p-6 rounded-xl border cursor-pointer transition-all duration-300 group ${
                  ...
                  <div className="mt-4 pl-14">
                    <ul className="space-y-2">
                      {industry.features.map((feature, i) => (
                        <motion.li
                          key={i}
                          className="flex items-start text-[#b0b0ff]"
                          initial={{ opacity: 0 }}
                          animate={{ opacity: 1 }}
                  ...
                  <div className="relative w-80 h-80">
                    ...
                    {industries[activeIndustry].features.map((feature, i) => {
                      ...
                      return (
                        ...
                        >
                          <div className="bg-[#12121a] p-3 rounded-lg border border-[#3d5afe]/30 text-xs text-center backdrop-blur-sm">
                            {feature}
                          </div>
                        </motion.div>
                      );
      ...
      <section className="py-10 px-6 sm:px-12 bg-[#12121a] relative overflow-hidden">
        {/* Background elements */}
        <div className="absolute top-0 left-0 w-full h-1/2 bg-gradient-to-b from-[#0a0a12] to-transparent opacity-30"></div>
            ...
            <div className="grid lg:grid-cols-2 gap-y-16">
              {steps.map((step, index) => (
                ...
                >
                  ...
                  <motion.div
                    whileHover={{ y: -5 }}
                    className="bg-[#0e0e15] p-8 rounded-xl border border-[#3d5afe]/10 hover:border-[#00bcd4]/50 transition-all duration-300 group cursor-pointer"
                  >
                    <div
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true, margin: "-100px" }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className="text-center p-8 bg-[#12121a] rounded-xl border border-[#3d5afe]/10 hover:border-[#00bcd4]/50 transition-all duration-300"
              >
