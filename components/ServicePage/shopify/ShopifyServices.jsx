...
const ShopifyServices = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-[#0F0F1A] to-[#1A1A2E] text-[#E0E0FF] overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden py-10">
        <div className="absolute top-0 left-0 w-full h-3/4 bg-gradient-to-br from-[#1A1A2E] via-[#16213E] to-[#0F3460] z-0"></div>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-12 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative bg-[#1A1A2E] p-8 rounded-2xl border border-[#7E6BF0] border-opacity-20 overflow-hidden transform perspective-1000 rotate-x-5">
              ...
              <div className="relative z-10">
                ...
                <div className="bg-[#0F0F1A] rounded-xl p-4 mb-6 overflow-hidden">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-4 bg-[#0F0F1A] rounded-xl border border-[#7E6BF0] border-opacity-10">
                  ...
                  <div className="p-4 bg-[#0F0F1A] rounded-xl border border-[#00D2AA] border-opacity-10">
                    <div className="flex items-center mb-2">
            ...
            <div className="flex overflow-x-auto pb-8 snap-x snap-mandatory hide-scrollbar">
              {services.map((service, index) => (
                ...
                >
                  ...
                  <p className="text-[#B0B0FF] mb-6">{service.description}</p>
                  ...
                  <button className="mt-6 text-sm font-medium flex items-center group">
      ...
      <section className="py-10 px-6 sm:px-12 bg-gradient-to-b from-[#0F0F1A] to-[#1A1A2E] relative">
      ...
      <section className="py-10 px-6 sm:px-12 bg-[#1A1A2E] relative">
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
  ...
  {successStories.map((story, index) => (
    <motion.div
      ...
      viewport={{ once: true }}
      transition={{ duration: 0.5, delay: index * 0.1 }}
      className="bg-gradient-to-br from-[#0F0F1A] to-[#1A1A2E] rounded-2xl overflow-hidden border border-[#7E6BF0] border-opacity-10 hover:border-opacity-30 transition-all duration-300 group"
    >
      <div className="relative h-48 overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-transparent to-[#0F0F1A] opacity-90 z-10"></div>
      ...
      <section className="py-10 px-6 sm:px-12 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#0F0F1A] to-[#1A1A2E] opacity-90"></div>
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <Link
              href="/portfolio"
              className="border-2 border-[#7E6BF0] text-[#7E6BF0] hover:bg-[#7E6BF0] hover:bg-opacity-10 font-semibold py-4 px-12 rounded-lg transition-colors duration-300"
            >
              View Our Work
            </Link>
          </motion.div>
