...
const ServicePaidMedia = () => {
  return (
    <section className="relative w-full bg-[#0a0a12] text-white py-20 px-6 md:px-12 lg:px-20 overflow-hidden">
      ...
      >
        <h3 className="text-3xl font-semibold text-[#00f0ff] mb-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 text-left">
          {[
            ...
            <motion.div
              ...
              className="p-6 rounded-2xl bg-[#12121a] shadow-lg border border-[#00f0ff]/20"
            >
      ...
      <motion.div
        ...
        className="mt-24"
      >
        <h3 className="text-3xl font-semibold text-center text-[#00f0ff] mb-10">
          What You Can Expect
        </h3>
        <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          {[
            ...
            <div
              key={idx}
              className="flex items-center space-x-3 p-4 rounded-xl bg-[#12121a] hover:bg-[#1c1c2e] transition-all border border-[#00f0ff]/10"
            >
