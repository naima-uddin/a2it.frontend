  ...
  return (
    <div className="bg-[#0a0a12] text-[#e0e0ff] overflow-hidden">
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center text-center px-6">
        ...
        >
          <span className="inline-block px-5 py-2 bg-[#12121a] rounded-full text-[#00f0ff] font-medium mb-6 shadow shadow-[#00f0ff]/30">
            Content & PR Services
          </span>
          ...
          <p className="text-lg text-[#b0b0ff]">
      ...
      <section className="py-20 px-6 sm:px-12 bg-[#12121a]">
        ...
        <p className="text-center text-[#b0b0ff] max-w-3xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
          {[
            ...
            <motion.div
              ...
              className="relative bg-[#0a0a12] p-6 rounded-2xl border border-[#00f0ff]/20 hover:border-[#00f0ff] transition-all duration-300 text-center group"
            >
              ...
              <item.icon className="mx-auto h-10 w-10 text-[#00f0ff]" />
              <h3 className="font-semibold mt-4">{item.title}</h3>
              <p className="text-sm text-[#b0b0ff] mt-2">{item.desc}</p>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      <section className="py-20 px-6 ml-16 sm:px-12 bg-[#0a0a12] grid lg:grid-cols-2 gap-12 items-center">
        <motion.div
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-12">
          {[
            ...
            <motion.div
              key={i}
              whileHover={{ scale: 1.05 }}
              className="bg-[#0a0a12] p-6 rounded-2xl border border-[#00f0ff]/20 hover:border-[#00f0ff] text-center transition-all duration-300"
            >
      ...
      {/* Final CTA */}
      <section className="py-18 px-6 sm:px-12 bg-gradient-to-br from-[#0a0a12] via-[#12121a] to-[#0a0a12] text-center">
        <motion.h2
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
        ...
        <p className="text-lg text-[#b0b0ff] max-w-xl mx-auto mb-8">
