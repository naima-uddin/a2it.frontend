  ...
  return (
    <div className="bg-[#0a0a12] text-[#e0e0ff] overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-6">
        <div className="absolute inset-0 bg-gradient-to-b from-[#0a0a12] via-[#12121a] to-[#0a0a12]"></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center py-24">
          <motion.div
            initial="hidden"
            whileInView="show"
            viewport={{ once: true }}
      ...
      <section className="py-24 px-6 sm:px-12 bg-[#12121a]">
        <div className="max-w-7xl mx-auto text-center mb-16">
          <motion.h2
            initial="hidden"
            whileInView="show"
            variants={fadeInUp}
            className="text-3xl sm:text-4xl font-bold text-[#e0e0ff] mb-4"
          >
        ...
        <div className="grid md:grid-cols-3 lg:grid-cols-5 gap-8 max-w-7xl mx-auto">
          {[
            ...
            <motion.div
              ...
              className="bg-[#0a0a12] p-6 rounded-2xl border border-[#00f0ff]/20 shadow-lg hover:shadow-[#00f0ff]/40 text-center transition-all duration-300"
            >
              <item.icon className="mx-auto h-12 w-12 text-[#00f0ff]" />
              <h3 className="font-semibold mt-4 text-xl">{item.title}</h3>
              <p className="text-[#b0b0ff] mt-2 text-sm">{item.desc}</p>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      <section className="py-24 px-6 sm:px-12">
        <div className="max-w-7xl mx-auto text-center mb-16">
          <motion.h2
            ...
            whileInView="show"
            variants={fadeInUp}
            className="text-3xl sm:text-4xl font-bold text-[#e0e0ff]"
          >
            Case Studies
          </motion.h2>
          <p className="text-[#b0b0ff] max-w-2xl mx-auto mt-2">
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-7xl mx-auto">
          {[
            ...
            <motion.div
              ...
              variants={fadeInUp}
              transition={{ delay: i * 0.1 }}
              className="bg-[#0a0a12] rounded-2xl overflow-hidden border border-[#00f0ff]/20 shadow-lg"
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-[#00f0ff]">{item.title}</h3>
                <p className="text-[#b0b0ff] mt-2">{item.desc}</p>
              </div>
            </motion.div>
          ))}
        </div>
      ...
      {/* Industries Section */}
      <section className="py-14 px-6 sm:px-12 bg-[#12121a]">
        <div className="max-w-7xl mx-auto text-center mb-16">
          <motion.h2
            initial="hidden"
            whileInView="show"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 max-w-7xl mx-auto text-center">
          {["Technology", "Healthcare", "Retail", "Finance", "Education"].map((industry, i) => (
            <motion.div
              ...
              variants={fadeInUp}
              transition={{ delay: i * 0.1 }}
              className="p-6 bg-[#0a0a12] border border-[#00f0ff]/20 rounded-xl shadow-lg hover:shadow-[#00f0ff]/40 transition-all duration-300"
            >
              <FiLayers className="mx-auto h-10 w-10 text-[#00f0ff]" />
