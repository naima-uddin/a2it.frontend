  ...
  return (
    <div className="bg-[#0a0a12] text-[#e0e0ff] overflow-hidden">
      ...
      <section className="relative flex items-center justify-center h-100 overflow-hidden">
        <div className="absolute inset-0 bg-[url('/assets/eBay/1.webp')] bg-cover bg-center opacity-20"></div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">
              Successful <span className="text-[#00f0ff]">Marketplace</span> Stores
            </h2>
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#0a0a12]/90 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                  <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                    ...
                    <p className="text-[#b0b0ff] text-sm">{store.results}</p>
                  </div>
                </div>
              </motion.div>
            ))}
