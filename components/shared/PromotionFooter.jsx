        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          ...
          <div className="bg-[#FFD6A7]/25 rounded-2xl p-6 md:p-8 shadow-2xl transparent">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <input name="name" placeholder="Your Name" className="w-full rounded-md p-3 border border-[#FFD6A7] bg-[#FFD6A7]/70 text-sm text-white placeholder:text-white/70 outline-none" required />
              <input name="email" type="email" placeholder="Email Address" className="w-full rounded-md p-3 border border-[#FFD6A7] bg-[#FFD6A7]/70 text-sm placeholder:text-white/70 outline-none text-white" required />
              <input name="phone" type="tel" placeholder="Phone Number" className="w-full rounded-md p-3 border border-[#FFD6A7] bg-[#FFD6A7]/70 text-sm text-white placeholder:text-white/70 outline-none" required />
